...
def data_load_all_proj():
    var0 = simpledialog.askstring("Data Load","Please enter the month and year(mm-yyyy): ")
    messagebox.showinfo("Message", "Please place the master file in specific folder")
    var1 = simpledialog.askstring("Data Load","Do you want to start loading master data? ")
    messagebox.showinfo("Message", "Please place the files in specific folder")
    var2 = simpledialog.askstring("Data Load","Do you want to start loading data? (Y/N): ")
    messagebox.showinfo("Message", "Please wait while the data is loading")
...
def generate_qr_code():
    var0 = simpledialog.askstring("QR IRN Generate","Please enter the Invoice month and year(mm-yyyy): ")
    messagebox.showinfo("Message", "Please wait while the QR IRN is generating")
...
def generate_report():
    var0 = simpledialog.askstring("Generate Invoice","Please enter the Invoice month and year(mm-yyyy): ")
    messagebox.showinfo("Message", "Please wait while the Invoice is gettting generated")
...
def freeze_data():
    var0 = simpledialog.askstring("Freeze data","Please enter the Invoice month and year(mm-yyyy): ")
    messagebox.showinfo("Message", "Please wait while the data is being freezed")
...
def delete_data():
    var0 = simpledialog.askstring("Delete data","Please enter the Invoice month and year(mm-yyyy): ")
    messagebox.showinfo("Message", "Please wait while the data is being deleted")
...
def generate_revenue_report():
    var0 = simpledialog.askstring("Delete data","Please enter the Invoice month and year(mm-yyyy): ")
    messagebox.showinfo("Message", "Please wait while the MIS Revenue Report is being generated")
